 ...
 */
public class AccessibilityAlipayTwoEvent extends AccessibilityEvent {
    public AccessibilityAlipayTwoEvent(int type) {
        super(type);
    }

    public AccessibilityAlipayTwoEvent() {
    }

    @Override
    public boolean operator() {
        return clickByText("转到支付宝账户");
    }
